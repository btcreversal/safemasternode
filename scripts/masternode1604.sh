...
COIN_REPO='https://github.com/safeminecoin/safemasternode.git'
COIN_TGZ='https://github.com/safeminecoin/safemasternode/releases/download/1.0/safemasternoded1604.tar.gz'
COIN_BOOTSTRAP='https://github.com/safeminecoin/safemasternode/releases/download/1.0/bootstrap.tar.gz'
