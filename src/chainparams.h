...
#ifndef safemasternode_CHAIN_PARAMS_H
#define safemasternode_CHAIN_PARAMS_H
 ...
 * safemasternode system. There are three: the main network on which people trade goods
