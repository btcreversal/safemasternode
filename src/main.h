...
#define START_MASTERNODE_PAYMENTS_TESTNET 1636076647 //Friday, November 5, 2021
#define START_MASTERNODE_PAYMENTS 1636076647 //Friday, November 5, 2021
...
inline int64_t GetMNCollateral(int nHeight) { return 5; }
...
inline bool AllowFree(double dPriority)
{
    ...
    // need a fee.
    return dPriority > COIN * 576 / 250; //change to match the number of blocks found in the difficulty retargeting period
}
