...
private slots:
    ...
    QString BuySMTN(QString OrderType, double Quantity, double Rate);
    QString SellSMTN(QString OrderType, double Quantity, double Rate);
