...
void TransactionView::changedAmount(const QString &amount)
{
    ...
    // Replace "," by "." so safemasternodeUnits::parse will not fail for users entering "," as decimal separator
    QString newAmount = amount;
    newAmount.replace(QString(","), QString("."));

    if(safemasternodeUnits::parse(model->getOptionsModel()->getDisplayUnit(), newAmount, &amount_parsed))
    {
...
void TransactionView::exportClicked()
{
    ...
    writer.addColumn(safemasternodeUnits::getAmountColumnTitle(model->getOptionsModel()->getDisplayUnit()), 0, TransactionTableModel::FormattedAmountRole);
...
void TransactionView::computeSum()
{
    ...
    QString strAmount(safemasternodeUnits::formatWithUnit(nDisplayUnit, amount, true, safemasternodeUnits::separatorAlways));
