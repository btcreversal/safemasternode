    ...
    filter(0)
{
    ...
    ui->listTransactions->setStyleSheet("color: #000000; background-image:url(\":/images/tree\"); background-repeat: no-repeat;  background-position: bottom; border: none; padding-top: 0px; padding-bottom: 0px;");
