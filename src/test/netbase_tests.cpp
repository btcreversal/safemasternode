...
{
    BOOST_CHECK(TestSplitHost("www.safemasternode.org", "www.safemasternode.org", -1));
    BOOST_CHECK(TestSplitHost("[www.safemasternode.org]", "www.safemasternode.org", -1));
    BOOST_CHECK(TestSplitHost("www.safemasternode.org:80", "www.safemasternode.org", 80));
    BOOST_CHECK(TestSplitHost("[www.safemasternode.org]:80", "www.safemasternode.org", 80));
