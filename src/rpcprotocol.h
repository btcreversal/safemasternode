...
#ifndef _safemasternodeRPC_PROTOCOL_H_
#define _safemasternodeRPC_PROTOCOL_H_ 1
...
// safemasternode RPC error codes
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // safemasternode is not connected
